...
namespace Teapot 
{
	...
	public:
		...
		inline Light& GetLight() { return m_modelHander->light; }

		inline void CreateModel(const Shapes::Shape& shapes, const std::string& nameObject){ m_modelHander->CreateModel(shapes, nameObject); };
	...
	private:
		...
		std::shared_ptr<Teapot::ModelHandler> m_modelHander;
